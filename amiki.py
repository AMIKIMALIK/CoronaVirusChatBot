...
SendButton = Button(base, font=("Verdana",12,'bold'), text="Send", width="12", height=5,
                    bd=0, bg="#ff6666", activebackground="#33cc33",fg='#ffffff',
                    command= send)
EntryBox = Text(base, bd=0, bg="#ffffff",width="29", height="5", font="Arial")
scrollbar.place(x=376,y=6, height=386)
ChatLog.place(x=6,y=6, height=386, width=370)
EntryBox.place(x=6, y=497, height=90, width=388)
SendButton.place(x=6, y=401, height=90, width=388)
base.mainloop()
